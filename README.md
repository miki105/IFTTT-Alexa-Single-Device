# Alexa-Control-Single-Device

This Project is a modified copy of Nassir Malik Project!!!

Control single ESP8266 with Alexa using IFTTT without opening a router's port/firewal.
